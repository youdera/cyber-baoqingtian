...
window.renderSourceCatalog=function(s){
 ...
 const names={sample_ok:'首页可解析',candidate_sample:'样本可识别，待接入',portal_checked:'门户已检查，待定位栏目',needs_adapter:'需要适配',failed:'本次访问失败',cancelled:'已停止'};
